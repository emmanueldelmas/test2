 ...
 * créer une tâche rake qui importe ces magasins dans une base de données (liste des champs à avoir en base : chain, name, latitude, longitude, address, city, zip, phone, country_code).
 ...
 * faire un filtre permettant d'afficher, à partir de sa position : 
  ...
  Et les afficher sur une carte au dessus de la liste.
